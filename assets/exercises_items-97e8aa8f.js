import{a as c,b as l}from"./api-b019429c.js";import{refs as i}from"./exercises_category_filter-61bd785a.js";import{P as L}from"./vendor-064ed679.js";import{openModalHandler as f}from"./exercise_modal-2e87af68.js";import"./notifier-bffe1249.js";const s={bodypart:"",muscles:"",equipment:"",keyword:"",page:1,limit:8},o=document.getElementById("tui-pagination-container"),v={itemsPerPage:8,visiblePages:3,centerAlign:!0},d=new L(o,v);let p="";i.subcategory.addEventListener("click",y);i.search.addEventListener("submit",w);function w(e){e.preventDefault();const t=e.target;s.keyword=t.elements.searchstr.value.trim().toLowerCase(),console.log(s),t.reset(),n()}function y(e){if(e.preventDefault(),!e.target.classList.contains("exercises-subcategory-item")&&!e.target.parentNode.classList.contains("exercises-subcategory-item"))return;i.search.classList.add("is-visible");const t=e.target.closest(".exercises-subcategory-item");p=t.children[1].textContent.toLowerCase();const a=t.children[0].textContent;s.page=1,i.title.insertAdjacentHTML("beforeend",` / <span class="exercises-title-span"> ${a}</span>`),i.subcategory.classList.add("open-card"),b(p,t)}function b(e,t){s.muscles="",s.bodypart="",s.equipment="",s.keyword="",e==="muscles"?(s.muscles=t.children[0].textContent.toLowerCase(),n()):e==="body parts"?(s.bodypart=t.children[0].textContent.toLowerCase(),n()):e==="equipment"&&(s.equipment=t.children[0].textContent.toLowerCase(),n())}function C(e){const t=e.map(({_id:a,bodyPart:r,name:g,rating:u,burnedCalories:m,target:h})=>`<li class="exercices-card">
