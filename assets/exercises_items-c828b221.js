import{a as c,b as l}from"./api-b019429c.js";import{refs as i}from"./exercises_category_filter-61bd785a.js";import{P as L}from"./vendor-064ed679.js";import{openModalHandler as f}from"./exercise_modal-2e87af68.js";import"./notifier-bffe1249.js";const s={bodypart:"",muscles:"",equipment:"",keyword:"",page:1,limit:8},o=document.getElementById("tui-pagination-container"),y={itemsPerPage:8,visiblePages:3,centerAlign:!0},d=new L(o,y);let p="";i.subcategory.addEventListener("click",w);i.search.addEventListener("submit",v);function v(e){e.preventDefault();const t=e.target;s.keyword=t.elements.searchstr.value.trim().toLowerCase(),console.log(s),t.reset(),n()}function w(e){if(e.preventDefault(),!e.target.classList.contains("exercises-subcategory-item")&&!e.target.parentNode.classList.contains("exercises-subcategory-item"))return;i.search.classList.add("is-visible");const t=e.target.closest(".exercises-subcategory-item");p=t.children[1].textContent.toLowerCase();const a=t.children[0].textContent;s.page=1,i.title.insertAdjacentHTML("beforeend",` / <span class="exercises-title-span"> ${a}</span>`),i.subcategory.classList.add("open-card"),b(p,t)}function b(e,t){s.muscles="",s.bodypart="",s.equipment="",s.keyword="",e==="muscles"?(s.muscles=t.children[0].textContent.toLowerCase(),n()):e==="body parts"?(s.bodypart=t.children[0].textContent.toLowerCase(),n()):e==="equipment"&&(s.equipment=t.children[0].textContent.toLowerCase(),n())}function C(e){const t=e.map(({_id:a,bodyPart:r,name:u,rating:g,burnedCalories:m,target:h})=>`<li class="exercices-card">
        ...
        </li>`).join("");i.subcategory.innerHTML=t,i.subcategory.addEventListener("click",f)}function n(){window.innerWidth>=1440&&(s.limit=9),document.querySelector(".loader").style.display="block",c.get(l,s).then(({page:t,totalPages:a,results:r})=>{C(r),r.length===0&&(i.subcategory.innerHTML='<li class = "exercises-text"><p>Unfortunately, <span class = "exercises-text-span">no results</span> were found. You may want to consider other search options to find the exercise you are looking for. Our range is wide and you have the opportunity to find more options that suit your needs.</p></li>'),d.reset(a*8),a<=1?o.classList.add("is-hidden"):o.classList.remove("is-hidden")}).catch(t=>console.log(t)).finally(()=>{document.querySelector(".loader").style.display="none"}),d.on("afterMove",t=>{const a=t.page;s.page=a,document.querySelector(".loader").style.display="block",c.get(l,s).then(({results:r})=>{C(r)}).catch(r=>console.log(r)).finally(()=>{document.querySelector(".loader").style.display="none"})})}function x(e){return e.charAt(0).toLowerCase()===e.charAt(0)?e.charAt(0).toUpperCase()+e.slice(1):e}
//# sourceMappingURL=exercises_items-c828b221.js.map
