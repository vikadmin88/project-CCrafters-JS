import{a as l,b as d}from"./api-0d4e8fa1.js";import{refs as r}from"./exercises_category_filter-fbf44de4.js";import{P as L}from"./vendor-064ed679.js";import{a as f}from"./rating_modal-c65721c4.js";const s={bodypart:"",muscles:"",equipment:"",keyword:"",page:1,limit:8},o=document.getElementById("tui-pagination-container"),v={itemsPerPage:8,visiblePages:3,centerAlign:!0},p=new L(o,v);let c="";r.subcategory.addEventListener("click",y);r.search.addEventListener("submit",w);function w(e){e.preventDefault();const t=e.target;s.keyword=t.elements.searchstr.value.trim().toLowerCase(),console.log(s),t.reset(),n()}function y(e){if(e.preventDefault(),!e.target.classList.contains("exercises-subcategory-item")&&!e.target.parentNode.classList.contains("exercises-subcategory-item"))return;r.search.classList.add("is-visible");const t=e.target.closest(".exercises-subcategory-item");c=t.children[1].textContent.toLowerCase();const a=t.children[0].textContent;s.page=1,r.title.insertAdjacentHTML("beforeend",` / <span class="exercises-title-span"> ${a}</span>`),r.subcategory.classList.add("open-card"),b(c,t)}function b(e,t){s.muscles="",s.bodypart="",s.equipment="",s.keyword="",e==="muscles"?(s.muscles=t.children[0].textContent.toLowerCase(),n()):e==="body parts"?(s.bodypart=t.children[0].textContent.toLowerCase(),n()):e==="equipment"&&(s.equipment=t.children[0].textContent.toLowerCase(),n())}function C(e){const t=e.map(({_id:a,bodyPart:i,name:g,rating:u,burnedCalories:h,target:m})=>`<li class="exercices-card">
        ...
        </li>`).join("");r.subcategory.innerHTML=t,r.subcategory.addEventListener("click",f)}function n(){window.innerWidth>=1440&&(s.limit=9),l.get(d,s).then(({page:t,totalPages:a,results:i})=>{C(i),i.length===0&&(r.subcategory.innerHTML='<li class = "exercises-text"><p>Unfortunately, <span class = "exercises-text-span">no results</span> were found. You may want to consider other search options to find the exercise you are looking for. Our range is wide and you have the opportunity to find more options that suit your needs.</p></li>'),p.reset(a*8),a<=1?o.classList.add("is-hidden"):o.classList.remove("is-hidden")}).catch(t=>console.log(t))}p.on("afterMove",e=>{const t=e.page;s.page=t,l.get(d,s).then(({results:a})=>{C(a)}).catch(a=>console.log(a))});function x(e){return e.charAt(0).toLowerCase()===e.charAt(0)?e.charAt(0).toUpperCase()+e.slice(1):e}
//# sourceMappingURL=exercises_items-a656d3e9.js.map
