import{a as x,b as L}from"./api-b019429c.js";import{n}from"./notifier-bffe1249.js";import"./vendor-064ed679.js";document.querySelector(".modal");let u=document.querySelector(".close-modal-btn"),p=document.querySelector(".add-favorite-btn");document.querySelector(".give-rating-btn");document.querySelector(".backdrop-modal");document.querySelector(".loader");let o={isFavorite:!1};function T(e){if(!e.target&&!e.target.classList.contains("card-button")&&!e.target.closest(".card-button").classList.contains("card-button"))return;let t;try{t=e.target.closest(".card-button").dataset.id}catch{t=""}t&&(m(),v(t))}function N(e){if(!e.target&&!e.target.classList.contains("favorites-list-button")&&!e.target.closest(".favorites-list-button").classList.contains("favorites-list-button"))return;let t;try{t=e.target.closest(".favorites-list-button").dataset.id}catch{t=""}t&&(m(),v(t))}function m(){document.querySelector(".backdrop-modal").classList.remove("visually-hidden"),document.querySelector(".modal").innerHTML='<div class="loader-modal"></div>',document.querySelector(".loader-modal").style.display="block"}function A(){}function j(){}function C(){document.querySelector(".backdrop-modal").classList.add("visually-hidden")}function $(e){Object.hasOwn(o,"isFavorite")&&o.isFavorite?(q(e),o.isFavorite=!1,n("success","The exercise has been removed from your favorites list")):(k(),o.isFavorite=!0,n("success","The exercise has been added to your favorites list")),f(o)}function k(e){let t=JSON.parse(localStorage.getItem("favorites"))||[];t.push(o),localStorage.setItem("favorites",JSON.stringify(t))}function q(e){const t=e.target.dataset.id;let r=(JSON.parse(localStorage.getItem("favorites"))||[]).filter(i=>i._id!==t);localStorage.setItem("favorites",JSON.stringify(r))}function M(e){if(e){let t,a=e;return t=(JSON.parse(localStorage.getItem("favorites"))||[]).filter(i=>i._id===a),o.isFavorite=!!t.length,t}}function v(e){M(e),I(e)}function f(e){document.querySelector(".modal").innerHTML=O(e),u=document.querySelector(".close-modal-btn"),u.addEventListener("click",C),p=document.querySelector(".add-favorite-btn"),p.addEventListener("click",$),document.querySelector(".give-rating-btn")}function I(e){e&&x.get(`${L}/${e}`,{}).then(t=>{o.isFavorite?(o=t,o.isFavorite=!0):(o=t,o.isFavorite=!1),f(t)}).catch(t=>n("error",`API error: ${t}`)).finally(()=>{try{document.querySelector(".loader-modal").style.display="none"}catch{}})}function s(e){return e.charAt(0).toUpperCase()+e.slice(1)}function O({_id:e,bodyPart:t,equipment:a,gifUrl:r,name:i,target:g,description:h,rating:l,burnedCalories:b,time:y,popularity:S,isFavorite:F}){let c=5,d=Number(l.toFixed());c-=d;let w='<r class="star-1"/>'.repeat(d).concat('<r class="star-0"/>'.repeat(c));return`<div class="modal-description-container">
    ...
    </div>`}export{A as hideModalHandler,N as openModalFavoritesHandler,T as openModalHandler,j as showModalHandler};
//# sourceMappingURL=exercise_modal-2e87af68.js.map
