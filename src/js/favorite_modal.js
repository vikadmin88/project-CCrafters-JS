...
let modalCard = document.querySelector('.modal-favorite');
...
export function openModalFavoritesHandler(e) {
  ...
  addLoader();
  openModal(id);
  document.addEventListener('keydown', closeFavoriteModalHandler);
  modal.addEventListener('click', closeFavoriteModalHandler);
}
...
export function closeFavoriteModalHandler(e) {
  ...
  document.removeEventListener('keydown', closeFavoriteModalHandler);
  modal.removeEventListener('click', closeFavoriteModalHandler);
}

function addLoader() {
  document.querySelector('.backdrop-favorite').classList.remove('visually-hidden');
  document.querySelector('.modal-favorite').innerHTML = '<div class="loader-favorite"></div>';
...
function markupAndReload(item) {
  document.querySelector('.modal-favorite').innerHTML = createMarkupExercisesCard(item);

  // refresh all elements after recreate them, and add listeners
  closeBtn = document.querySelector('.close-modal-btn');
  closeBtn.addEventListener('click', closeFavoriteModalHandler);

  favBtn = document.querySelector('.add-favorite-btn');
  favBtn.addEventListener('click', removeFromFavoriteStorage);
